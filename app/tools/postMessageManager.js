System.register([], function(exports_1, context_1) {
    ...
    var CALLBACK_MESSAGE_TYPE, PostMessageManager;
    return {
        setters:[],
        execute: function() {
            CALLBACK_MESSAGE_TYPE = '_CALLBACK_MESSAGE_TYPE_';
            PostMessageManager = class PostMessageManager {
                constructor(iframe) {
                    this.messageId = 0;
                    this.eventHandlers = {};
                    this.callbacks = {};
            ...
            exports_1("PostMessageManager", PostMessageManager);
        }
    }
});
