import X2JS = require('./xml2Json');

const REG_EMOJI_ENCODE = /<span class="(emoji emoji[a-zA-Z0-9]+)"><\/span>/g;
const REG_EMOJI_DECODE = /###__EMOJI__(emoji emoji[a-zA-Z0-9]+)__###/g;
